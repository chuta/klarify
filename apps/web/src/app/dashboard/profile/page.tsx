...
export default async function ProfilePage({
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* ── Identity card ── */}
      <section className="mb-6 overflow-hidden rounded-2xl border border-[#CCCCCC] bg-white shadow-sm">
      ...
      {/* ── Edit name ── */}
      <section className="mb-6 rounded-2xl border border-[#CCCCCC] bg-white p-6 shadow-sm">
