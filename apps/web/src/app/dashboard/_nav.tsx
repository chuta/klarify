...
export const DASHBOARD_NAV: NavSection[] = [
  {
    title: 'Setup',
    items: [
      { href: '/dashboard/onboarding', label: 'Get Started', icon: <SetupIcon /> },
    ],
  },
  {
    title: 'ComplianceOS',
    items: [
      ...
      { href: '/dashboard/roadmap', label: 'Roadmap', icon: <ListIcon /> },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/classify', label: 'Classify Product', icon: <ClassifyIcon /> },
      { href: '/dashboard/scenario', label: 'Scenario Simulator', icon: <ScenarioIcon /> },
      { href: '/dashboard/jurisdiction', label: 'Jurisdiction Expansion', icon: <GlobeIcon /> },
      { href: '/dashboard/specialists', label: 'Specialists', icon: <SpecialistIcon /> },
    ],
  },
  {
    title: 'Account',
    items: [
      ...
      { href: '/dashboard/account/notifications',   label: 'Notifications',  icon: <BellIcon /> },
    ],
  },
];
...
function ClassifyIcon(): JSX.Element {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true">
...
function ScenarioIcon(): JSX.Element {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true">
...
function SpecialistIcon(): JSX.Element {
  return (
    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8} aria-hidden="true">
