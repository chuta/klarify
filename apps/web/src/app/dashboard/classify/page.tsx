    ...
    <DashboardPageShell>
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-[#555]">
          Describe your product in plain language. Klarify will map it against Nigerian
          and African regulatory frameworks (ISA 2025, SEC Digital Asset Rules, MLPPA 2022,
          CBN VASP Guidelines) and return a Regulatory Identity Card.
        </p>
      </header>
